...
- Add regression tests against the [OSF Biosignal Test Data Repository](https://osf.io/uc7wn/files/osfstorage) ([#23](https://github.com/cbrnr/XDF.jl/pull/23) by [Alberto Barradas](https://github.com/abcsds))
